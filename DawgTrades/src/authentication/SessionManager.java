...
public class SessionManager
{
            ...
            throws DTException 
    {
        ...
        RegisteredUser loginPerson = null;
        RegisteredUser knownPerson = null;
        Session s = null;
        ...
        loginPerson = objectModel.createRegisteredUser();
        loginPerson.setName( username );
        loginPerson.setPassword( password );
        
        Iterator<RegisteredUser> persons = persistence.restoreRegisteredUser( loginPerson );
        if( persons.hasNext() ) {
             knownPerson = persons.next();
             System.out.println( "Have person!" );
             System.out.println( "id: " + knownPerson.getId() );
             System.out.println( "userName: " + knownPerson.getName() );
            ...
            throws DTException
    {
        ...
        if( loggedIn.containsKey(person.getName()) ) {
            ...
            qs.setRegisteredUser(person);
            return qs.getSessionId();
        }
        session.setRegisteredUser(person);
            ...
            throws DTException
    {
        ...
        loggedIn.remove( s.getRegisteredUser().getName() );
    }
