...
public class BrowseCategoryPageTwo extends HttpServlet{
	
	private static final long serialVersionUID = 1L;
    static  String         templateDir = "WEB-INF/templates";
    static  String         resultTemplateName = "BrowseCategoryPageTwo-Result.ftl";
	...
	public void doPost( HttpServletRequest req, HttpServletResponse res )
        ...
        //
        categoryNameString = req.getParameter( "category" );
        ...
        try {
            persistables = logic.browseCategory(categoryNameString);
        } 
        catch( Exception e ) {
