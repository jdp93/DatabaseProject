...
public class UpdateCategoryPageTwo extends HttpServlet{

	private static final long serialVersionUID = 1L;
    static  String         templateDir = "WEB-INF/templates";
    static  String         resultTemplateName = "UpdateCategoryPageTwo-Result.ftl";
            ...
            throws ServletException, IOException
    {
        ...
        try {
        	logic.updateCategory(name, newName, parent, attrTypes);
        } 
        catch ( Exception e ) {
