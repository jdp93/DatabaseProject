...
public class SetMembershipPageTwo extends HttpServlet{

	private static final long serialVersionUID = 1L;
    static  String         templateDir = "WEB-INF/templates";
    static  String         resultTemplateName = "SetMembershipPageTwo-Result.ftl";
            ...
            throws ServletException, IOException
    {
        ...
        try {
            ...
            DTError.error( cfg, toClient, "Price should be a number and is: " + priceString );
            return;
        }

        if( price <= 0 ) {
            DTError.error( cfg, toClient, "Non-positive price: " + price );
            return;
        }
