...
import edu.uga.dawgtrades.logic.impl.AdministratorServices;
...
public class TerminateAccountPageTwo extends HttpServlet{

	private static final long serialVersionUID = 1L;
    static  String         templateDir = "WEB-INF/templates";
    static  String         resultTemplateName = "TerminateAccountPageTwo-Result.ftl";
            ...
            throws ServletException, IOException
    {
        ...
        try {
        	logic.deleteUser(session.getRegisteredUser().getName());
        } 
        catch ( Exception e ) {
