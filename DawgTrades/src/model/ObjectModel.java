...
{
	/**
	 * Set the persistence for this ObjectModel
	 * 
	 * @param persistence
	 */
	...
	/**
	* Given a RegisteredUser, find all the RegisteredUsers who have reviewed that RegisteredUser, registeredUser must be persistent
	* 
	* @param modelRegisteredUser
	* @return an Iterator of RegisteredUsers who reviewed the argument RegisteredUser
	*/
	public Iterator<RegisteredUser> findReviewers(RegisteredUser modelRegisteredUser) throws DTException;
	
	/**
	* Given a RegisteredUser, find all the RegisteredUsers who have been reviewed by that RegisteredUser, registeredUser must be persistent
	* 
	* @param modelRegisteredUser
	* @return an Iterator of RegisteredUsers who were reviewed by the argument RegisteredUser
	*/
	...
	/**
	 * Given a RegisteredUser, find all the Auctions he has bid on, registeredUser must be persistent.
	 * 
	...
	/**
	 * Given an Auction, find all the RegisteredUsers who bid on that Auction, the registeredUser must be persistent.
	 * 
	 * @param auction
	 * @return
	 * @throws DTException
	...
	/**
	 * Given an Auction, find all the Bids on that Auction, the Auction must be persistent.
	 * 
	 * @param auction
	 * @return
	 * @throws DTException
